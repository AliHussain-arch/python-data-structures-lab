...
def manage_students():
    students = ['Jaber', 'Ebrahim', 'Nohaiz']
    first_student = students[1]
    last_student = students[2]
    return f'Second student’s name : {first_student}', f'Last student’s name {last_student}'
...
home_town = {'city': 'Manama', 'state': 'Capital Governate', 'population': '727,000'}
...
def list_home_town_items(hometown):
    list_home_town_items = []
